...
curl -kLs https://raw.githubusercontent.com/reno1314/danted/master/install_R.sh -o install.sh && bash install.sh  --port=18801 --user=888 --passwd=888 && /etc/init.d/sockd start
